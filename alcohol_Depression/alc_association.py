...
# performing apriori algorithm on 2 columns of JSS_DATASET.xlsx, one column is the alc_consumption and other column is n_depression_233.
...
if not anxiety_to_alcohol_rule.empty:
    ...
    print("No rule found for Depression -> Alcohol Consumption")

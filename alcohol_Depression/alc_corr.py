...
new_df_depression['LE_depression'] = pd.to_numeric(new_df_depression['LE_depression'], errors='coerce')
...
correlation = new_df_depression['LE_depression'].corr(new_df_depression['LE_alc_consumption'])

# Display the correlation coefficient
print(f"\nCorrelation between Alcohol Consumption and Depression: {correlation}")
